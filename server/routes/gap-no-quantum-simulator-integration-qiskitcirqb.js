...
const FEATURE_SLUG = 'no-quantum-simulator-integration-qiskitcirqb';
const FEATURE_TITLE = 'No quantum simulator integration (Qiskit/Cirq/Braket)';
const PROJECT = 'AIQuantumComputingAssistant';

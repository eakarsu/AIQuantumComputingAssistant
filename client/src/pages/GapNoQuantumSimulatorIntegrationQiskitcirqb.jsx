...
export default function GapNoQuantumSimulatorIntegrationQiskitcirqb() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-quantum-simulator-integration-qiskitcirqb', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No quantum simulator integration (Qiskit/Cirq/Braket)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIQuantumComputingAssistant - Gap feature</p>
